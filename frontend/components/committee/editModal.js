...
export default function UpdateCommittee({ prevComm }) {
  ...
  const committee_name = prevComm.committee_name;
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await fetch("/api/committee/update", {
      ...
      body: JSON.stringify({ committee_name, roleDetails }),
    });
